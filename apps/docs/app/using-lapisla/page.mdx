...
After completing the proof, you can share a permalink to it or register any snapshot of it by the sidebar. Sharing a proof does not require registration, but importing it does.
